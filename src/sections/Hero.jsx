...
const Hero = () => {
  //sm is for small devices in tailwind css
  //xl for extra large device in tailwind css
  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x pt-28">
        <p className="text-xl font-montserrat text-slate-gray mt-2">
          Our <span className="text-coral-red">Winter</span> collections
        </p>
        ...
        <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm">
          Explore fashionable Nike arrivals, superior comfort, and innovation
